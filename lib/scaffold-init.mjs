...
const EXEMPLAR_DIR = join(REPO_ROOT, "examples/jsonplaceholder-cli");

const FROM = "jsonplaceholder";
const FROM_UPPER = "JSONPLACEHOLDER";
const FROM_TITLE = "JSONPlaceholder";
